...
export default function Footer({ setActiveTab }: FooterProps) {
  return (
    <footer className="bg-[#f3f3f3] border-t border-[#e1bec0] py-12 px-6 md:px-8 mt-12 mb-16 md:mb-0">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex gap-8 font-sans text-sm font-medium text-[#5d5f5f]">
          <a href="#" className="hover:text-[#6f0022] transition-colors">Điều khoản</a>
          <a href="#" className="hover:text-[#6f0022] transition-colors">Bảo mật</a>
          <a href="#" className="hover:text-[#6f0022] transition-colors">Liên hệ</a>
        </div>
