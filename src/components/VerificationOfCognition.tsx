  ...
  return (
    <section className="py-20 px-6 md:px-8 bg-white relative">
      <div className="max-w-[900px] mx-auto animate-fade-in">
            ...
            >
              ...
              {expandedExample === "galileo" && (
                <div className="bg-white p-6 border-t border-[#C9B5A3] space-y-4">
                  ...
                  <div className="bg-white border border-[#C9B5A3] p-4 rounded">
            ...
            >
              <div className="bg-[#F0E8DF] p-6">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[#663300] ml-3 flex-shrink-0">{expandedExample === "fakenews" ? "▲" : "▼"}</span>
                </div>
              </div>
              ...
              {expandedExample === "fakenews" && (
                <div className="bg-white p-6 border-t border-[#C9B5A3] space-y-4">
                  <div className="bg-[#E8D5C4] p-4 rounded">
                    <p className="font-serif text-sm text-[#663300] font-bold mb-2">❌ Hành vi phổ biến:</p>
                  ...
                  <div className="bg-[#F0E8DF] p-4 rounded">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <Shield className="w-8 h-8 text-[#663300] flex-shrink-0" />
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#1a1c1c] font-sans">
              Vì sao thực tiễn là tiêu chuẩn của chân lý?
            </h3>
          </div>

          <div className="bg-[#F0E8DF] border-l-4 border-[#663300] p-6 rounded-r-lg mb-8">
            <p className="font-serif text-sm md:text-base text-[#1a1c1c] leading-relaxed mb-4">
          ...
          <div className="bg-white border border-[#C9B5A3] p-6 rounded-lg">
            <h4 className="font-sans font-bold text-lg text-[#1a1c1c] mb-4">Thách thức hiện nay:</h4>
            <div className="space-y-3 font-serif text-sm md:text-base text-[#3a3c3c]">
              <div className="flex items-start">
                <AlertCircle className="w-5 h-5 text-[#663300] flex-shrink-0 mr-3 mt-0.5" />
            ...
            <div className="bg-[#E8D5C4] p-4 rounded mt-6">
              <p className="font-serif text-sm md:text-base text-[#663300] font-bold mb-3">
        ...
        {/* CTA Section */}
        <div className="bg-[#663300] text-white rounded-lg p-8 text-center">
